...
app = Flask(
    __name__,
    template_folder="chart/src/templates",
    static_folder="chart/src/static"
)
...
def index() -> str:
    ...
    genre_counts_data = get_genre_counts_data(
        genre_counts_labels_overlap, genre_counts
    )
